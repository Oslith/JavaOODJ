 ...
 * @author User
 */
public class JF_VendorRegistration extends javax.swing.JFrame {
    ...
    public JF_VendorRegistration() {
        ...
        public JF_VendorRegistration(Administrator admin) {
        this.admin = admin;
        initComponents();
    ...
    private void JBAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBAddActionPerformed
        ...
        if(JFUsername.getText().equals("")||JFLocation.getText().equals("")||JFBalance.getText().equals("")||JFStoreName.getText().equals("")||JFPhoneNumber.getText().equals("")||JFPassword.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(this,"The Password doesn't match");
        } else if (admin.CheckDup(this,VendorTable,Username,StoreName,Location,PhoneNumber)) {
        }else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JF_VendorRegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JF_VendorRegistration().setVisible(true);
            }
        });
    }
